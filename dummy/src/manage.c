 ...
 **/
static s32 e1000_mng_write_cmd_header(
    struct e1000_hw* hw,
 ...
 **/
static s32 e1000_mng_host_if_write(struct e1000_hw* hw,
                                   u8* buffer,
                                   u16 length,
                                   u16 offset,
                                   u8* sum) {
...
s32 e1000e_mng_write_dhcp_info(struct e1000_hw* hw, u8* buffer, u16 length) {
  ...
  ret_val =
      e1000_mng_host_if_write(hw, buffer, length, sizeof(hdr), &(hdr.checksum));
  if (ret_val)
    return ret_val;
